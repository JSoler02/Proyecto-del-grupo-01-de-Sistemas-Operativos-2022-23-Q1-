...
namespace ProyectoSO
{
    public partial class Cueva_Maritima : Form
    {
        ...
        // Velocidades para las PLATAFORMAS verticales 
        int verticalSpeed_v1 = 3; int verticalSpeed_v2 = 3; int verticalSpeed_v4 = 3; int verticalSpeed_v3 = 3;
        ...
        bool plataformaVertical3_activa1_1; bool plataformaVertical3_activa2_1; 
        bool plataformaVertical3_activa3_1; bool plataformaVertical3_activa4_1; 
        bool plataformaVertical3_ACT;

        bool plataformaVertical4_activa1_1; bool plataformaVertical4_activa2_1; 
        ...
        public Cueva_Maritima(int idPartida, Socket server)
        {
            InitializeComponent();
        ...
        private void RestartGame()
        {
            ...
            // plataforma vertical 3
            vertical3.Width = 200 / 2;
            vertical3.Height = 50 / 2;
            vertical3.Image = Image.FromFile("plataforma3.png");
            vertical3.SizeMode = PictureBoxSizeMode.Zoom;
            vertical3.BackColor = Color.Transparent;
            // plataforma vertical 4
            ...
            placa3_1.Width = 120 / 2;
            placa3_1.Height = 36 / 2;
            placa3_1.Image = Image.FromFile("placa3_desactivada.png");
            placa3_1.SizeMode = PictureBoxSizeMode.Zoom;
            placa3_1.BackColor = Color.Transparent;

            placa4_1.Width = 120 / 2;
            placa4_1.Height = 36 / 2;
            placa4_1.Image = Image.FromFile("placa4_desactivada.png");
            placa4_1.SizeMode = PictureBoxSizeMode.Zoom;
            placa4_1.BackColor = Color.Transparent;
            ...
            placa3_1.BringToFront();
            placa4_1.BringToFront();
            ...
            plataformaVertical3_Bot_limit.Visible = false;
        ...
        private void ColisionesPersonajesPlataformas(Control x)
        {
            ...
            if (misPicsPersonajes[0].Bounds.IntersectsWith(x.Bounds))
            {
                ...
                else
                {
                    ...
                    {
                        Jug1.SetY(vertical4.Top - Jug1.GetAlturaNormal()); // se moverá con la velocidad de la plataforma
                    }
                    if ((string)x.Name == "vertical3")
                    {
                        Jug1.SetY(vertical3.Top - Jug1.GetAlturaNormal()); // se moverá con la velocidad de la plataforma
                    }
                }
            }
            ...
            if (misPicsPersonajes[1].Bounds.IntersectsWith(x.Bounds))
            {
                ...
                else
                {
                    ...
                    if ((string)x.Name == "vertical3")
                    {
                        Jug2.SetY(vertical3.Top - Jug2.GetAlturaNormal()); // se moverá con la velocidad de la plataforma
                    }
                    if ((string)x.Name == "vertical4")
                    {
                        Jug2.SetY(vertical4.Top - Jug2.GetAlturaNormal()); // se moverá con la velocidad de la plataforma
                    }
                }
            }
            ...
            if (misPicsPersonajes[2].Bounds.IntersectsWith(x.Bounds))
            {
                ...
                else
                {
                    ...
                    if ((string)x.Name == "vertical3")
                    {
                        Jug3.SetY(vertical3.Top - Jug2.GetAlturaNormal()); // se moverá con la velocidad de la plataforma
                    }
                    if ((string)x.Name == "vertical4")
                    {
                        Jug3.SetY(vertical4.Top - Jug2.GetAlturaNormal()); // se moverá con la velocidad de la plataforma
                    }
                }
            }
            ...
            if (misPicsPersonajes[3].Bounds.IntersectsWith(x.Bounds))
            {
                ...
                else
                {
                    ...
                    if ((string)x.Name == "vertical3")
                    {
                        Jug4.SetY(vertical3.Top - Jug4.GetAlturaNormal()); // se moverá con la velocidad de la plataforma
                    }
                    if ((string)x.Name == "vertical4")
                    {
                        Jug4.SetY(vertical4.Top - Jug4.GetAlturaNormal()); // se moverá con la velocidad de la plataforma
                    }
                }
            }
        }
        ...
        private void Cueva_Maritima_KeyDown(object sender, KeyEventArgs e)
        {

        }

        private void Cueva_Maritima_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void ColisionesPersonajesPlaca3_1(Control x)
        {
            // Colisiones Jugador 1 - placa 1
            if (misPicsPersonajes[0].Bounds.IntersectsWith(x.Bounds))
            {
                if (plataformaVertical3_activa1_1 == false)
                {
                    plataformaVertical3_activa1_1 = true;
                }
            }
            else
            {
                if (plataformaVertical3_activa1_1 == true)
                {
                    plataformaVertical3_activa1_1 = false;
                }
            }
            // Colisiones Jugador 2 - placa 1
            if (misPicsPersonajes[1].Bounds.IntersectsWith(x.Bounds))
            {
                if (plataformaVertical3_activa2_1 == false)
                {
                    plataformaVertical3_activa2_1 = true;

                }
            }
            else
            {
                if (plataformaVertical3_activa2_1 == true)
                {
                    plataformaVertical3_activa2_1 = false;
                }
            }
            // Colisiones Jugador 3 - placa 1
            if (misPicsPersonajes[2].Bounds.IntersectsWith(x.Bounds))
            {
                if (plataformaVertical3_activa3_1 == false)
                {
                    plataformaVertical3_activa3_1 = true;
                }
            }
            else
            {
                if (plataformaVertical3_activa3_1 == true)
                {
                    plataformaVertical3_activa3_1 = false;
                }
            }
            // Colisiones Jugador 4 - placa 1
            if (misPicsPersonajes[3].Bounds.IntersectsWith(x.Bounds))
            {
                if (plataformaVertical3_activa4_1 == false)
                {
                    plataformaVertical3_activa4_1 = true;
                }
            }
            else
            {
                if (plataformaVertical3_activa4_1 == true)
                {
                    plataformaVertical3_activa4_1 = false;
                }
            }
        }
        private void ColisionesPersonajesPlaca4_1(Control x)
        {
            // Colisiones Jugador 1 - placa 1
            if (misPicsPersonajes[0].Bounds.IntersectsWith(x.Bounds))
            {
                if (plataformaVertical4_activa1_1 == false)
                {
                    plataformaVertical4_activa1_1 = true;
                }
            }
            else
            {
                if (plataformaVertical4_activa1_1 == true)
                {
                    plataformaVertical4_activa1_1 = false;
                }
            }
            // Colisiones Jugador 2 - placa 1
            if (misPicsPersonajes[1].Bounds.IntersectsWith(x.Bounds))
            {
                if (plataformaVertical4_activa2_1 == false)
                {
                    plataformaVertical4_activa2_1 = true;

                }
            }
            else
            {
                if (plataformaVertical4_activa2_1 == true)
                {
                    plataformaVertical4_activa2_1 = false;
                }
            }
            // Colisiones Jugador 3 - placa 1
            if (misPicsPersonajes[2].Bounds.IntersectsWith(x.Bounds))
            {
                if (plataformaVertical4_activa3_1 == false)
                {
                    plataformaVertical4_activa3_1 = true;
                }
            }
            else
            {
                if (plataformaVertical4_activa3_1 == true)
                {
                    plataformaVertical4_activa3_1 = false;
                }
            }
            // Colisiones Jugador 4 - placa 1
            if (misPicsPersonajes[3].Bounds.IntersectsWith(x.Bounds))
            {
                if (plataformaVertical4_activa4_1 == false)
                {
                    plataformaVertical4_activa4_1 = true;
                }
            }
            else
            {
                if (plataformaVertical4_activa4_1 == true)
                {
                    plataformaVertical4_activa4_1 = false;
                }
            }
        }
